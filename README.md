...
The dashboard is **separate from the `.deb` package**. Install `.deb` on grading benches; run the UI via **Docker/GHCR `latest`** on a technician laptop.
...
| **[Development](DEVELOPMENT.md)**                                                                            | Style, pytest, workflow                                                                                                                                                                                          |
